library(ade4)
Ross <- read.delim('gf1.txt', row.names = 1, check.names = FALSE)
Affy <- read.delim('pm2.txt', row.names = 1, check.names = FALSE)
classes <-  read.delim('group2.txt', row.names = 1, check.names = FALSE)
